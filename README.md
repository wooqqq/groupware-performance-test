...
> nGrinder 20 vUser / 5분 부하 테스트 기준  
> (로컬 PC 1대에서 Spring Boot + nGrinder Agent + DB + Redis를 동시 실행하는 환경 제약으로 20 vUser 기준 측정. v1/v2 상대적 개선폭이 핵심.)
...
| P95 응답시간 | 측정 예정 | 37ms | - |
| 에러율 | 측정 예정 | 0% | - |
| DB 커넥션 최대 사용량 | 측정 예정 | 9 / 20 | - |

> **nGrinder "Errors" 수치에 대해**  
> nGrinder 결과에 Errors 49,904건이 표시되지만, Grafana 서버 에러율은 0%입니다.  
